...
export const OrganizationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        organizationRead: async (org_id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const OrganizationApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async organizationRead(org_id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await OrganizationApiAxiosParamCreator(configuration).organizationRead(org_id, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const OrganizationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async organizationRead(org_id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return OrganizationApiFp(configuration).organizationRead(org_id, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class OrganizationApi extends BaseAPI {
     ...
     * @memberof OrganizationApi
     */
    public async organizationRead(org_id: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return OrganizationApiFp(this.configuration).organizationRead(org_id, options).then((request) => request(this.axios, this.basePath));
    }
}
